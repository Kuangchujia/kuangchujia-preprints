...
**本仓库是什么**：本系列科普稿预印本的**镜像与备份入口**（PDF ＋ 书目元数据），与 Zenodo 上一一对应。**正式引用请以 Zenodo 记录为准**。

**配套数据集**：本系列所依据的历法公共数据集（二十四节气交节时刻、历代历法改革年表、干支纪日对照表）见 <https://github.com/Kuangchujia/chinese-calendar-dataset>，Zenodo concept DOI [10.5281/zenodo.22788686](https://doi.org/10.5281/zenodo.22788686)。
<!-- ANCHOR-BLOCK-END -->
